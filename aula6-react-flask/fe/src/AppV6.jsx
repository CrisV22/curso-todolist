// State, map e criação novas tarefas dinâmicas
...
function AppV6() {
  ...
  // Função só é executada uma vez quando o componente é montado
  useEffect(() => {
    ...
    <div className="min-h-screen w-screen bg-[#05080f] space-y-11 flex flex-col items-center">
      ...
      <div className="bg-[#0a0e17] rounded-lg space-y-6 p-8 w-2/3">
        ...
        <div className="space-y-4">
          <p className="text-sm text-slate-200 font-medium">Título da Tarefa</p>
          <input
            value={title}
        ...
        <button
          onClick={() => {
            ...
            setTitle(""); // Limpando o campo de título
            setDescription(""); // Limpando o campo de descrição
          }}
