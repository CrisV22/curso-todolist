...
function App() {
  return (
    <div className="min-h-screen w-screen bg-[#05080f] space-y-11 flex flex-col items-center">
      ...
      <p className="text-center text-[#94B3D1] text-lg leading-relaxed">
      ...
      {/* CARD */}
      <div className="bg-[#0a0e17] rounded-lg space-y-6 center p-8 w-2/3">
        <h2>
        ...
        <button className="bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] text-black px-6 py-3 rounded-lg font-medium flex gap-2 w-full justify-center hover:from-[#2563EB] hover:to-[#1E3A8A] transition-all">
          <span>+</span>
